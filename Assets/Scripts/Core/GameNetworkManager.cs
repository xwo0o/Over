    ...
    public override void OnServerAddPlayer(NetworkConnectionToClient conn)
    {
        ...
        else if (currentScene == gameScene)
        {
            ...
            if (player != null)
            {
                ...
                // 默认使用01角色
                player.CmdSelectCharacter("01");
                Debug.Log($"[GameNetworkManager] 玩家对象已创建，默认使用01角色");
            }
        }
        else
        {
