...
public class InventorySlotUI : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IDropHandler
{
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (sourceSlot.slotIndex < 0 || sourceSlot.slotIndex >= inventoryUIController.targetInventory.slots.Count ||
            slotIndex < 0 || slotIndex >= inventoryUIController.targetInventory.slots.Count)
        {
